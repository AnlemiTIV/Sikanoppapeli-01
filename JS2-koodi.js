...
if (window.location.href.match('index.html') || window.location.href.match('pisteiden_maara.html') != null ){    
    var temp = "2"; //pitää olla vähintään 2 pelaajaa
...
if (window.location.href.match('sikanoppa.html') != null) {
...
function nopanHeitto() {
    ...
    if (heittokerta != 1){
        ...
        console.log("jos heittokerta ei ole 1, tuon > " + kertyneetPisteet2 + " pitäisi säilyttää pelikerran kaikki pisteet")
        console.log("jos siis on edelliseltä kierrokselta 12, niin pitäisi myös alkaa 12:sta, ei 8:sta")
    }
    ...
    if (firstRandomNum != "1"){
        ...
        htmlnNakyvaPiste.innerHTML = kertyneetPisteet2; //näyttää kertyneet pisteet?
        ...
        //******noppakerranpisteet[heittoGlobal] = 0;
        heittokerta = 1;
    ...
    //OG (Number(noppakerranpisteet[heittoGlobal]) >= Number(peliLoppuu))
...
function vaihdaVuorosi(){
    ...
    noppakerranpisteet20[heittoGlobal] += kierroksenPisteet; //täällä bugi...
